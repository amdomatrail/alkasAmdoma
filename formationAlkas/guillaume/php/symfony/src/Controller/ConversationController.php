...
class ConversationController extends AbstractController
{
    ...
    public function new(Request $request, ConversationRepository $conversationRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $conversation->setSlug($conversation->getTitre());
    ...
    #[Route('/{slug}', name: 'app_conversation_message', methods: ['GET'])]
        public function indexMessage(Conversation $conversation,MessageRepository $messageRepository): Response
        {

            return $this->render('conversation/message.html.twig', [
                'conversation' => $conversation,
                'messages' => $messageRepository->findBy(['conversation'=>$conversation->getId()]
                )]);
        }
